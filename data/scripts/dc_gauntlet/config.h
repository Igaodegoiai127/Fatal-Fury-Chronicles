...
// Instance control. 
#define dc_gauntlet_get_instance()		dc_instance_get(DC_GAUNTLET_MEMBER_INSTANCE)
#define dc_gauntlet_set_instance(value)	dc_instance_set(DC_GAUNTLET_MEMBER_INSTANCE, value)
#define dc_gauntlet_reset_instance()	dc_instance_reset(DC_GAUNTLET_BASE_ID, DC_GAUNTLET_MEMBER_INSTANCE, DC_GAUNTLET_MEMBER_THE_END)
#define dc_gauntlet_free_instance()		dc_instance_free(DC_GAUNTLET_BASE_ID, DC_GAUNTLET_MEMBER_INSTANCE, DC_GAUNTLET_MEMBER_THE_END)
#define dc_gauntlet_dump_instance()		dc_instance_dump(DC_GAUNTLET_BASE_ID, DC_GAUNTLET_MEMBER_INSTANCE, DC_GAUNTLET_MEMBER_THE_END)
#define dc_gauntlet_export_instance()	dc_instance_export(DC_GAUNTLET_BASE_ID, DC_GAUNTLET_MEMBER_INSTANCE, DC_GAUNTLET_MEMBER_THE_END)
#define dc_gauntlet_import_instance()	dc_instance_import(DC_GAUNTLET_BASE_ID, DC_GAUNTLET_MEMBER_INSTANCE, DC_GAUNTLET_MEMBER_THE_END)
#define dc_gauntlet_free_export()		dc_instance_free_export(DC_GAUNTLET_BASE_ID, DC_GAUNTLET_MEMBER_INSTANCE, DC_GAUNTLET_MEMBER_THE_END)
