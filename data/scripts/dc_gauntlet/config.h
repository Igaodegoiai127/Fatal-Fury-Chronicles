...
#define DC_GAUNTLET_VAR_KEY_INITIAL_POSITION		DC_GAUNTLET_BASE_ID + 3
#define DC_GAUNTLET_VAR_KEY_INVERT_X				DC_GAUNTLET_BASE_ID + 4
#define DC_GAUNTLET_VAR_KEY_INVERT_Y				DC_GAUNTLET_BASE_ID + 5
#define DC_GAUNTLET_VAR_KEY_INVERT_Z				DC_GAUNTLET_BASE_ID + 6
#define DC_GAUNTLET_VAR_KEY_MAP						DC_GAUNTLET_BASE_ID + 7
#define DC_GUANTLET_VAR_KEY_MODEL_NAME				DC_GAUNTLET_BASE_ID + 8
#define DC_GAUNTLET_VAR_KEY_OFFSET_X				DC_GAUNTLET_BASE_ID + 9
#define DC_GAUNTLET_VAR_KEY_OFFSET_Y				DC_GAUNTLET_BASE_ID + 10
#define DC_GAUNTLET_VAR_KEY_OFFSET_Z				DC_GAUNTLET_BASE_ID + 11
#define DC_GAUNTLET_VAR_KEY_PROJECTILE_DIRECTION	DC_GAUNTLET_BASE_ID + 12
#define DC_GAUNTLET_VAR_KEY_PROJECTILE_RELATIVE		DC_GAUNTLET_BASE_ID + 13
...
#define dc_gauntlet_set_instance(value)	dc_instance_set(DC_GAUNTLET_VAR_KEY_INSTANCE, value)
#define dc_gauntlet_reset_instance()	dc_instance_reset(DC_GAUNTLET_BASE_ID, DC_GAUNTLET_VAR_KEY_INSTANCE, DC_GAUNTLET_VAR_KEY_THE_END)
#define dc_gauntlet_free_instance()		dc_instance_free(DC_GAUNTLET_BASE_ID, DC_GAUNTLET_VAR_KEY_INSTANCE, DC_GAUNTLET_VAR_KEY_THE_END)
#define dc_gauntlet_dump_instance()		dc_instance_dump(DC_GAUNTLET_BASE_ID, DC_GAUNTLET_VAR_KEY_INSTANCE, DC_GAUNTLET_VAR_KEY_THE_END)
#define dc_gauntlet_export_instance()	dc_instance_export(DC_GAUNTLET_BASE_ID, DC_GAUNTLET_VAR_KEY_INSTANCE, DC_GAUNTLET_VAR_KEY_THE_END)
#define dc_gauntlet_import_instance()	dc_instance_import(DC_GAUNTLET_BASE_ID, DC_GAUNTLET_VAR_KEY_INSTANCE, DC_GAUNTLET_VAR_KEY_THE_END)
#define dc_gauntlet_free_export()		dc_instance_free_export(DC_GAUNTLET_BASE_ID, DC_GAUNTLET_VAR_KEY_INSTANCE, DC_GAUNTLET_VAR_KEY_THE_END)
