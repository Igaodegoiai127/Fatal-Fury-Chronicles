...
#define DC_GAUNTLET_DEFAULT_PROJECTILE_MAP			NULL()
#define DC_GAUNTLET_DEFAULT_PROJECTILE_RELATIVE		0
#define DC_GAUNTLET_DEFAULT_PROJECTILE_STATIONARY	PROJECTILE_STATIONARY_DISABLED
#define DC_GAUNTLET_DEFAULT_PROJECTILE_TYPE			PROJECTILE_TYPE_KNIFE
...
#define DC_GAUNTLET_VAR_KEY_INITIAL_POSITION		DC_GAUNTLET_VAR_KEY_BASE_ID + 2
#define DC_GAUNTLET_VAR_KEY_INVERT_X				DC_GAUNTLET_VAR_KEY_BASE_ID + 3
#define DC_GAUNTLET_VAR_KEY_INVERT_Y				DC_GAUNTLET_VAR_KEY_BASE_ID + 4
#define DC_GAUNTLET_VAR_KEY_INVERT_Z				DC_GAUNTLET_VAR_KEY_BASE_ID + 5
#define DC_GUANTLET_VAR_KEY_MODEL_NAME				DC_GAUNTLET_VAR_KEY_BASE_ID + 6
#define DC_GAUNTLET_VAR_KEY_OFFSET_X				DC_GAUNTLET_VAR_KEY_BASE_ID + 7
#define DC_GAUNTLET_VAR_KEY_OFFSET_Y				DC_GAUNTLET_VAR_KEY_BASE_ID + 8
#define DC_GAUNTLET_VAR_KEY_OFFSET_Z				DC_GAUNTLET_VAR_KEY_BASE_ID + 9
#define DC_GAUNTLET_VAR_KEY_PROJECTILE_DIRECTION	DC_GAUNTLET_VAR_KEY_BASE_ID + 10
#define DC_GAUNTLET_VAR_KEY_PROJECTILE_MAP			DC_GAUNTLET_VAR_KEY_BASE_ID + 11
#define DC_GAUNTLET_VAR_KEY_PROJECTILE_RELATIVE		DC_GAUNTLET_VAR_KEY_BASE_ID + 12
#define DC_GAUNTLET_VAR_KEY_PROJECTILE_STATIONARY	DC_GAUNTLET_VAR_KEY_BASE_ID + 13
#define DC_GAUNTLET_VAR_KEY_PROJECTILE_TYPE			DC_GAUNTLET_VAR_KEY_BASE_ID + 14
#define DC_GAUNTLET_VAR_KEY_SPAWN					DC_GAUNTLET_VAR_KEY_BASE_ID + 15
#define DC_GAUNTLET_VAR_KEY_THE_END					16			// Should always last, with a value one higher than previous key ID.
